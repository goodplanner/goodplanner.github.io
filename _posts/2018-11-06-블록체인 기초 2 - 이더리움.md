...
nohub geth ........
상세로그 : --verbosity 5
nohup geth --identity "PrivateNetwork1" --datadir "/home/user01/data_testnet/"  --port "30303" --rpc --rpcaddr 0.0.0.0 --rpcport "8545" --rpccorsdomain  "*" --nodiscover --networkid 1910 --rpcapi "admin,db,eth,net,web3,minor" --verbosity 5 2>>/home/user01/data_testnet/geth.log &
